...
var classCallCheck = function(t, e) {
  ...
  VMAPAdSource = function t(e) {
    for (var a in (classCallCheck(this, t),
  ...
  VMAPAdBreak = (function() {
    function t(e) {
      ...
      e.childNodes)) {
        ...
        switch (i.localName) {
          case 'AdSource':
            this.adSource = new VMAPAdSource(i);
            break;
          case 'TrackingEvents':
            for (var s in i.childNodes) {
              var r = i.childNodes[s];
              'Tracking' === r.localName &&
      ...
      createClass(t, [
        {
          ...
          value: function(t, e) {
            for (var a in this.trackingEvents) {
              var i = this.trackingEvents[a];
              if (i.event === t) {
                var s = i.uri;
                'error' === i.event && (s = s.replace('[ERRORCODE]', e)),
                  this.tracker(s);
              }
            }
          }
  ...
  VMAP = function t(e) {
    if (
      ...
      null == (null != e ? e.documentElement : void 0) ||
        'VMAP' !== e.documentElement.localName)
    )
      throw new Error('Not a VMAP document');
    for (var a in ((this.version = e.documentElement.getAttribute('version')),
    (this.adBreaks = []),
    (this.extensions = []),
    e.documentElement.childNodes)) {
      var i = e.documentElement.childNodes[a];
      switch (i.localName) {
        case 'AdBreak':
          this.adBreaks.push(new VMAPAdBreak(i));
          break;
        case 'Extensions':
          this.extensions = i.childNodes;
      }
