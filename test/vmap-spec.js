...
const readXMLFile = function(file) {
  const url = path
    .resolve(path.dirname(module.filename), file)
    .replace(/\\/g, '/');
...
describe('VMAP', function() {
  ...
  describe('#1 ad break', function() {
    ...
    it('should have ad source id 1', () =>
      adbreak.adSource.id.should.equal('1'));
    ...
    it('should have one tracking event', function() {
      ...
      adbreak.trackingEvents[0].uri.should.equal(
        'http://server.com/breakstart'
      );
      ...
      adbreak.trackingEvents[3].uri.should.equal(
        'http://server.com/error?[ERRORCODE]'
      );
    });
  ...
  describe('#2 ad break', function() {
    ...
    it('should have time offset set to 00:10:23.125', () =>
      adbreak.timeOffset.should.equal('00:10:23.125'));
    it('should have break type linear', () =>
      adbreak.breakType.should.equal('linear'));
    it('should have break id set to myid', () =>
      adbreak.breakId.should.equal('myid'));
    it('should have ad source id 2', () =>
      adbreak.adSource.id.should.equal('2'));
    it('should have only vast data set', function() {
      should(adbreak.adSource.vastData).not.be.null;
      should(adbreak.adSource.adTagURI).be.null;
      should(adbreak.adSource.customData).be.null;
  ...
  describe('#3 ad break', function() {
    ...
    it('should have time offset set to end', () =>
      adbreak.timeOffset.should.equal('end'));
    it('should have break type linear', () =>
      adbreak.breakType.should.equal('linear'));
    it('should have break id set to mypost', () =>
      adbreak.breakId.should.equal('mypost'));
    it('should have ad source id 3', () =>
      adbreak.adSource.id.should.equal('3'));
    it('should have only vast data set', function() {
      should(adbreak.adSource.vastData).not.be.null;
